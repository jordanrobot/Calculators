...
* [HP/Force Speed](http://www.scenic-shop.com/Calculators/hp_force_speed.html)
...
* [Yoyo Winch Calcs](http://www.scenic-shop.com/Calculators/winch_yoyo.html)
    * Added calculator
    * Added [formula](http://scenic-shop.com/Calculators/formulas/mdwiki.html#!winch_yoyo.md) page

###2014-Jan-20
---

* [Pulley Pressure](http://www.scenic-shop.com/Calculators/pulleys.html)
    * Renamed from Pulley Calcs
    * Fixed error where D:d ratio did not calculate when specifying a tread diameter
* [D:d Ratios](http://www.scenic-shop.com/Calculators/D-to-d.html)
...
* [Frustum](http://www.scenic-shop.com/Calculators/frustum_flatten.html)
    * Re-wrote math code
...
* [Pulley Calcs](http://www.scenic-shop.com/Calculators/pulleys.html)
...
* [Linepull Winch](http://www.scenic-shop.com/Calculators/winch_linepull.html)
...
* [Piston Force & Speed](http://www.scenic-shop.com/Calculators/piston_force_speed.html)
    * added column formatting
* [ANSI Chain Calculator](http://www.scenic-shop.com/Calculators/chain_ansi.html)
    * added column formatting
    * added formulas page
* [Navigation](http://www.scenic-shop.com/Calculators/)
    * Added link to the index of formula pages

###2014-Jan-04
---

* [Unit Converter](http://www.scenic-shop.com/Calculators/unit_converter.html)
...
* [Plain Bearing: PV](http://www.scenic-shop.com/Calculators/bearing_plainPV.html)
...
* Revised [Disclaimer](http://www.scenic-shop.com/Calculators/disclaimer.html) language
* Added new grouped buttons on the bottom of each page, containing a link to the image, formulas, and disclaimer
* [Capstan Holding Force](http://www.scenic-shop.com/Calculators/capstan_holding_force.html)
    * Added formula page
    * Updated variable selection code
    * Added diagram
* [HP Force/Speed](http://www.scenic-shop.com/Calculators/hp_force_speed.html)
    - Fixed formula button placement errors
* [Resultant Force](http://www.scenic-shop.com/Calculators/resultant_force.html)
    * Added formula page
...
* Added formula pages for the following calculators:
    * [Linepull Winch](http://www.scenic-shop.com/Calculators/winch_linepull.html)
    * [Piston Force & Speed](http://www.scenic-shop.com/Calculators/piston_force_speed.html)
    * [Drums: Yoyo Payout](http://www.scenic-shop.com/Calculators/drums_yoyopayout.html)
    * [HP Force/Speed](http://www.scenic-shop.com/Calculators/hp_force_speed.html)
* Added an index for the formula pages
* [Drums: Helical Payout](http://www.scenic-shop.com/Calculators/drums_helicalpayout.html) - Edited the formula page to make terms clearer.
* Moved [Plain Bearing: Radial PV](http://www.scenic-shop.com/Calculators/bearing_plainPV_radial.html) from "In Progress" to "Released"
* Added the following variable in [Piston Force & Speed](http://www.scenic-shop.com/Calculators/piston_force_speed.html)
    * Temperature
    * Atmospheric Pressure
    * Pressure Drop was changed from a % to a psi value
* Re-organized winch pages to individual pages, starting with [Linepull Winch](http://www.scenic-shop.com/Calculators/winch_linepull.html)
...
* Added diagrams to the following calculators:
    * [Drums: Helical Payout](http://www.scenic-shop.com/Calculators/drums_helicalpayout.html)
    * [Drums: Yoyo Payout](http://www.scenic-shop.com/Calculators/drums_yoyopayout.html)
    * [Drums: Max Unbraced Length](http://www.scenic-shop.com/Calculators/drums_unbraced_length.html)
    * [Piston Force & Speed](http://www.scenic-shop.com/Calculators/piston_force_speed.html)


`In Progress`

* Added a [Plain Bearing: Radial PV](http://www.scenic-shop.com/Calculators/bearing_plainPV_radial.html) calculator, with diagram, and a link to the formulas and explanation page [Formulas](http://scenic-shop.com/Calculators/formulas/mdwiki.html#!bearing_plainPV_radial.md)
...
* Color coding and variable selection working for the following:
    * [Capstan](http://www.scenic-shop.com/Calculators/capstan_holding_force.html)
    * [Fleet Angle](http://www.scenic-shop.com/Calculators/fleet_angle.html)


* [Drums](http://www.scenic-shop.com/Calculators/): 
...
* [Constants](http://www.scenic-shop.com/Calculators/constants.html):
    * Alphabetized list.
...
* [Bronze Bearings PV](http://www.scenic-shop.com/Calculators/bronze_PV.html): Added a placeholder link
* [Motions](http://www.scenic-shop.com/Calculators/motions.html): Renamed slider to "Motion Profile"
* [Motions](http://www.scenic-shop.com/Calculators/motions.html): Roughed in forces formulas
...
* [Motion Calculator](http://www.scenic-shop.com/Calculators/motions.html): Completed initial motion formulas.
